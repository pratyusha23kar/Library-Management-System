		               ...
		               <div class="col-md-8 form-group text-center">
		               		<label>New User Registration</label>
								...
								<div class="form-group">
                                	...
                                	<form:errors path="age" cssClass="error" cssStyle="color:red"/>
								</div>
								<div class="form-group">
									<label>Gender</label>
		               		 	...
		               		 	<div class="form-group">
		               		 		<label>Role</label>
		               		 		<form:select path="select_role" items="${allRoles}" itemValue="id" itemLabel="role" />
		               		 	</div>
		               		 	<div class="form-group">
									<label>Address1</label>
                                	<form:input path="address.Address1" type="text" />
								</div>
								<div class="form-group">
									<label>Address2</label>
                                	<form:input path="address.Address2" type="text" />
								</div>
								<div class="form-group">
									<label>city</label>
								...
								<div class="form-group">
		               		 	...
		               		 	<div class="form-group">
		               		 		<form:label path="imageName">Image</form:label></td>
            						<input type="file" name="imageName" />
            					</div>
            				</div>
            					<div class="form-group">
                    				<button type="submit" class="btn btn-primary btn-block" > Resigster  </button>
								</div>
								<div class="form-group">
