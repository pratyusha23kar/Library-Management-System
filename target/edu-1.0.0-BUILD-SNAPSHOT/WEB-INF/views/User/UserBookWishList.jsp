...
<div id="wrapper">
				...
				<li>
					<br><br><br><br><br>
						...
						<ul>
							...
							<li class="active"><a href="${contextPath}/edu/User/WishlistBooks"><i class="fa fa-book" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Wishlist Books</span></a></li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
			...
			<br><br>
			<label>Existing books in wishlist</label>
			<br><br><br><br><br><br>
			<form:form>
            	...
            	<table class="table movie-table">
			        ...
			        <c:forEach var="wlb" items="${WishlistBooks}">
					 		<tr>
								...
								<td><a href="${contextPath}/edu/User/BookDetails/WishList/userRemoveBook/${wlb.getBookId()}"><span class="glyphicon glyphicon-remove"></span></a><td>		
					 		</tr>
					 	</c:forEach> 
			        </tbody>
		    	</table>
        ...
        <br><br>
            <form:form action="${contextPath}/edu/User/BookDetails/userwishlist" method="GET">
            <div class="row" id="main" >
            <div class="col-sm-10 col-md-10 well_top" id="content">
			       <div class="form-group col-md-10">
					 		...
					 		<tr>
								...
								<c:choose>
	    							<c:when test="${b.getCurrent_status() == 'Notavailable'}">
								       <td><a href="${contextPath}/edu/User/BookDetails/WishList/AddBook/${b.getBookId()}"><span class="glyphicon glyphicon-plus"></span></a><td>
	    							</c:when>    
	    							<c:otherwise>
	        							<td></td>
	    							</c:otherwise>
