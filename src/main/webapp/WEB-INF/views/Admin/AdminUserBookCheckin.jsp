...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form:form action="${contextPath}/edu/User/BookDetails/Checkin/${userdetails.getId()}" method="GET">
            <div class="row" id="main" >
            <div class="col-sm-10 col-md-10 well_top" id="content">
			       <div class="form-group col-md-10">
					 		...
					 		<tr>
								...
								<c:choose>
	    							<c:when test="${b.getCurrent_status() == 'available'}">
								       <td><a href="${contextPath}/edu/User/BookDetails/Checkin/user/${userdetails.getId()}/Book/${b.getBookId()}"><span class="glyphicon glyphicon-plus"></span></a><td>
	    							</c:when>    
	    							<c:otherwise>
	        							<td></td>
	    							</c:otherwise>
