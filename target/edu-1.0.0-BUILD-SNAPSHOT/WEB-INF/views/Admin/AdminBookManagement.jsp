...
<div id="wrapper">
				...
				<li>
					<br><br><br><br><br>
						...
						<ul>
							...
							<li class="active"><a href="${contextPath}/edu/Admin/BookManagement"><i class="fa fa-book" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Book Managment</span></a></li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <!-- Page Heading -->
            <form:form action="${contextPath}/edu/GetBook/ByCriteria" method="get">
					...
					<div class="form-group col-md-6">  
			            <div class="form-group col-md-3">
							<label class="form-check">
			                 	<input class="form-check-input" type="radio" name="SearchBy" value="SearchByISBN" required="required">
			                    <span class="form-check-label"> Search By ISBN</span>
							</label>
						</div>
						<div class="form-group col-md-3">
							<label class="form-check">
			                     <input class="form-check-input" type="radio" name="SearchBy" value="SearchByAuthor" required="required">
			                     <span class="form-check-label"> Search By Author</span>
							</label>
						</div>
						<div class="form-group col-md-3">
			                <label class="form-check">
			                      <input class="form-check-input" type="radio" name="SearchBy" value="SearchByTitle" required="required">
			                      <span class="form-check-label"> Search By Title</span>
							</label>
						</div>
					</div>  
					<div class="form-group col-md-6">
					 	...
					 	<c:forEach var="b" items="${Searchbook}">
					 		<tr>
								...
								<td><c:out value="${b.getCurrent_status()}"/></td>
					 			<td><a href="${contextPath}/edu/BookDetails/Update/${b.getBookId()}"><span class="glyphicon glyphicon-edit"></span></a></td>
					 			<td><a href="${contextPath}/edu/BookDetails/Delete/${b.getBookId()}"><span class="glyphicon glyphicon-remove-circle"></span></a></td>
					 		</tr>
					 	</c:forEach> 
					 </tbody>
				</table>
            ...
            <div class="row">
                 <div class="col-sm-10 col-md-10" id="content">
                     <a href="${contextPath}/edu/Admin/AddNewBook" class="btn btn-mokka btn-lg" role="button"><span class="glyphicon glyphicon-book glyphsize"></span> <br />Add <span class="glyphicon glyphicon-plus green"></span><br />Book</a>
            	</div>
            </div>
            <!-- /.row -->
        </div>
