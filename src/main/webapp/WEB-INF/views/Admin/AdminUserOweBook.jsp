			        ...
			        <c:forEach var="ob" items="${OweBooks}">
					 		<tr>
								...
								<td><c:out value="${ob.getFine()}"/></td>
					 			<td><a href="${contextPath}/edu/User/BookDetails/Return/user/${userdetails.getId()}/book/${ob.getBook().getBookId()}"><span class="glyphicon glyphicon-book"></span></a></td>
					 			<td><a href="${contextPath}/edu/User/BookDetails/Renew/user/${userdetails.getId()}/book/${ob.getBook().getBookId()}"><span class="glyphicon glyphicon-book"></span></a></td>
					 		</tr>
					 	</c:forEach> 
			        </tbody>
		    	</table>
