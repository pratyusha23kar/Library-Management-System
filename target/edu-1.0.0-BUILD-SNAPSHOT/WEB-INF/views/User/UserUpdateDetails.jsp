				...
				<li>
					<br><br><br><br><br>
						...
						<ul>
							...
							<li class="active"><a href="${contextPath}/edu/UserDetails/Update"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Profile update</span></a></li>
						</ul>
						</div>
				</li>
            </ul>
