...
<div id="wrapper">
				...
				<li>
					<br><br><br><br><br>
						...
						<ul>
							...
							<li class="active"><a href="${contextPath}/edu/User/CheckinBooks"><i class="fa fa-book" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Check in</span></a></li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form:form action="${contextPath}/edu/User/Checkin/SearchBooks" method="GET">
            <div class="row" id="main" >
            <div class="col-sm-10 col-md-10 well_top" id="content">
			       <div class="form-group col-md-10">
            	...
            	<table class="table movie-table">
			        ...
			        <c:forEach var="b" items="${Searchbook}">
					 		<tr>
								...
								<c:choose>
	    							<c:when test="${b.getCurrent_status() == 'available'}">
								       <td><a href="${contextPath}/edu/User/Checkin/AddBookToCart/${b.getBookId()}"><span class="glyphicon glyphicon-plus"></span></a><td>
	    							</c:when>    
	    							<c:otherwise>
	        							<td></td>
	    							</c:otherwise>
        ...
        <br><br><br>
        <form:form>
        	<a href="${contextPath}/edu/User/BookCart" class="btn btn-info btn-lg">
