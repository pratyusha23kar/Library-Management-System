...
<div id="wrapper">
    ...
    <div id="page-wrapper">
			        ...
			        <c:forEach var="b" items="${BooksinCart}">
					 		<tr>
								...
								<td><c:out value="${b.getCurrent_status()}"/></td>
					 			<td><a href="${contextPath}/edu/User/BookDetails/Cart/CheckOut/Delete/User/${userdetails.getId()}/Book/${b.getBookId()}"><span class="glyphicon glyphicon-remove red"></span></a><td>
					 		</tr>
					 	</c:forEach> 
			        </tbody>
		    	</table>
        ...
        <br><br><br>
        <form:form>
        	<a href="${contextPath}/edu/User/BookDetails/Cart/CheckOut/${userdetails.getId()}" class="btn btn-info btn-lg">
