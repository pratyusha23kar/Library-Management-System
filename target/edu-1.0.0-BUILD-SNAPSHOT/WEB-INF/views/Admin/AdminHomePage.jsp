            ...
            <ul class="nav navbar-nav side-nav">
				...
				<li>
					<br><br><br><br><br>
						<div class="navi">
						<ul>
							<li class="active"><a href="${contextPath}/edu/Admin/dashboard"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Home</span></a></li>
							...
							<!--  <li><a href="${contextPath}/edu/Admin/UpdateProfile"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Update Profile</span></a></li>-->
						</ul>
						</div>
				</li>
            </ul>
